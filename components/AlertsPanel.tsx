...
export default function AlertsPanel({
  ...
  return (
    <div className="fixed inset-0 z-50 flex">
      ...
      {/* Panel */}
      <div className="relative ml-auto w-full max-w-md bg-white dark:bg-gray-800 shadow-2xl flex flex-col h-full animate-slideInRight">
        {/* Header */}
        ...
        <div className="flex-1 overflow-y-auto">
          {!alerts ? (
            ...
            Object.entries(groupedAlerts).map(([group, groupAlerts]) => (
              <div key={group}>
                <div className="sticky top-0 px-4 py-2 bg-gray-50 dark:bg-gray-700/50 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">
                  {group}
                </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <button
                            ...
                            className="text-sm font-medium text-gray-900 dark:text-white hover:text-orange-600 dark:hover:text-orange-400 truncate block w-full text-left"
                          >
                            {alert.documentTopic}
                          </button>
                      ...
                      <div className="flex items-center gap-2 mt-3 pl-7">
                        ...
                        <div className="relative">
                          ...
                          {snoozeMenuAlertId === alert._id && (
                            <div className="absolute left-0 mt-1 w-32 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg z-10 py-1">
