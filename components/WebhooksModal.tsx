...
export default function WebhooksModal({ workspaceId, onClose }: WebhooksModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-surface rounded-2xl shadow-xl w-full max-w-3xl max-h-[90vh] overflow-hidden border border-border animate-scaleIn">
        {/* Header */}
        <div className="flex items-center justify-between p-4 border-b border-border">
          <div className="flex items-center gap-2">
            <Icons.Link className="w-5 h-5 text-indigo-500" />
            <h2 className="text-lg font-semibold text-main">Webhooks</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="overflow-y-auto max-h-[calc(90vh-60px)]">
          ...
          {showCreateForm && !createdSecret && (
            <div className="p-4 border-b border-border space-y-4">
              <h3 className="font-medium text-main">Create New Webhook</h3>
                        ...
                        {categoryEvents.map((event) => (
                          ...
                          >
                            ...
                            <div className="flex-1">
                              <div className="text-sm font-medium text-main font-mono">
                                {event.id}
                              </div>
          ...
          {/* Webhooks list */}
          <div className="p-4">
            <h3 className="text-sm font-medium text-secondary mb-3">Your Webhooks</h3>
            {webhooks.length === 0 ? (
              <p className="text-secondary text-sm">No webhooks created yet.</p>
            ) : (
                        ...
                        <div className="space-y-3">
                          <div>
                            ...
                            <div className="flex items-center gap-2 mt-1">
                              <code className="text-sm font-mono text-main">
                                {webhook.secret}
                              </code>
                              <button
          ...
          <div className="p-4 border-t border-border">
            ...
            <p className="text-sm text-secondary mt-2">
              Verify by computing HMAC-SHA256 of <code className="bg-gray-100 dark:bg-surface-hover px-1 rounded">{"timestamp.payload"}</code> with your secret.
            </p>
          </div>
        </div>
      </div>
